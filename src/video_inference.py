...
ALARM_PATH = r"../assets/alarm2.wav"
VIDEO_PATH = r"../assets/test_video.mp4"
IMG_SIZE = (64, 64)
...
if not cap.isOpened():
    print("Khong mo duoc file video")
    raise SystemExit
...
print(f"FPS delay: {delay} ms")

while True:
    ret, frame = cap.read()
    if not ret:
        print("Da chay het video hoac khong doc duoc frame")
        break
